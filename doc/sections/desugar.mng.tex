...
then merged to form another open term. \lstinline{new} instantiates a trait by
taking the \textit{lazy fixpoints} of the resulting open term. For example,
...
an expression in the target language. The target expression (call-by-name pure untyped lambda
...
simplified version below: \ottusedrule{\ottdruleSubXXR{}} By this rule, one can
