...
arize in a concrete practical application: Extensible Visitors and/or
Object Algebras. Such limitations arize from the \emph{covariant
...
of \name. Section~\ref{} shows how Object Algebras and Extensible
...
relation. This is for example the situation that is discussed by Cook
et al.~\cite{}. 
...
between the signatures of the two
accept methods: 
...
The need for dynamic inheritance arizes in composition operators for
