...
value \lstinline{()}).
\lstinputlisting[linerange=27-34]{../examples/box.txt}% APPLY:linerange=CIRCLE_FNS
...
\lstinputlisting[linerange=48-53]{../examples/box.txt}% APPLY:linerange=BUTTON_FNS
...
\lstinputlisting[linerange=57-59]{../examples/box.txt}% APPLY:linerange=ROUNDBUTTON_DEF

\noindent Finally we create a round button on the fly and test its functionality
as follows:
\lstinputlisting[linerange=112-115]{../examples/box.txt}% APPLY:linerange=ROUNDBUTTON_TEST
...
\lstinputlisting[linerange=64-66]{../examples/box.txt}% APPLY:linerange=ASOVAL_DEF
...
\lstinputlisting[linerange=71-73]{../examples/box.txt}% APPLY:linerange=CONFLICT_DEF
...
by \name again.
\lstinputlisting[linerange=79-80]{../examples/box.txt}% APPLY:linerange=CONFLICT_RESOLVE
...
\lstinputlisting[linerange=93-95]{../examples/box.txt}% APPLY:linerange=CIRCLE_FNS2
...
\lstinputlisting[linerange=84-89]{../examples/box.txt}% APPLY:linerange=NORM_DEF
...
\lstinputlisting[linerange=99-101]{../examples/box.txt}% APPLY:linerange=POINT_FUNC
...
in.
\lstinputlisting[linerange=105-105]{../examples/box.txt}% APPLY:linerange=ROUNDBUTTON_TEST2
