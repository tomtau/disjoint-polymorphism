...
method \lstinline{radius}.\bruno{Should we talk about the second
  option here?} \jeremy{it's mentioned later on.}
...
\bruno{This tour doesn't go over polymorphism!} \jeremy{seems hard to
  incorporate polymorphism into the example, next section mentions it when
  polymorphism first appears}
