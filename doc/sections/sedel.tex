...
The first example shows a simple trait \lstinline{point} with its two
...
Next we represent buttons in the same way as points. Here is the trait of
buttons:
...
as follows:
\lstinputlisting[linerange=122-125]{../examples/box.txt}% APPLY:linerange=ROUNDBUTTON_TEST
...
\lstinputlisting[linerange=81-82]{../examples/box.txt}% APPLY:linerange=CONFLICT_DEF
...
\lstinputlisting[linerange=87-88]{../examples/box.txt}% APPLY:linerange=CONFLICT_RESOLVE
...
\lstinputlisting[linerange=102-105]{../examples/box.txt}% APPLY:linerange=CIRCLE_FNS2
...
\lstinputlisting[linerange=92-98]{../examples/box.txt}% APPLY:linerange=NORM_DEF
...
\lstinputlisting[linerange=109-111]{../examples/box.txt}% APPLY:linerange=POINT_FUNC
...
\lstinputlisting[linerange=115-115]{../examples/box.txt}% APPLY:linerange=ROUNDBUTTON_TEST2
