...
\bruno{I think what what we want to do here is to say that data
  constructions are a bad idea. Instead if we want to define Object
  Algebra values we should define them directly through the accept
  method (see code below). You should explain what's the advantage of doing so.}
...
encountered to justify this alternative design!}
\jeremy{done}\bruno{not yet. see previous comment.}
