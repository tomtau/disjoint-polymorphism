...
\lstinputlisting[linerange=719-725]{../examples/case_study1.txt}% APPLY:linerange=SUPER_DEF
...
% \lstinputlisting[linerange=729-730]{../examples/case_study1.txt}% APPLY:linerange=TEST_TEST
