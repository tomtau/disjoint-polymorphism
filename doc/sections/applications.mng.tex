...
\lstinputlisting[linerange=537-547]{../examples/case_study.txt}% APPLY:linerange=ARITH
...
% \lstinputlisting[linerange=738-739]{../examples/case_study.txt}% APPLY:linerange=TEST_TEST
